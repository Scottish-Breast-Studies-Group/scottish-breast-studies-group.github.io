...
* **Key Outcomes:** The primary measure is the difference between the tumour size shown on imaging and the true size found during surgery. Secondary outcomes track patient preference and the accuracy of each scan in finding additional cancerous areas in the breast.
* **Locations:** Recruiting from ten NHS hospital sites across the UK.
* **[Website](https://www.dundee.ac.uk/projects/cesar-study)**
...
* **Key Outcomes:** Cancer detection rates, recall rates, interval cancers, workforce impact, cost-effectiveness, and patient and staff perspectives on the use of AI in screening.
* **[Website](https://warwick.ac.uk/fac/sci/med/research/ctu/trials/edith/public/)**
* **Locations:** Approximately 30 breast screening centres across England, Scotland, Wales, and Northern Ireland. The Scottish element is led jointly by the University of Aberdeen, NHS Grampian, and the University of Glasgow.
* **Funder:** £11 million from the National Institute for Health and Care Research Health Technology Assessment Programme (NIHR HTA).
...
* **Key Outcomes:** Primary: AI datapoint extraction accuracyand summary quality. Secondary: Treatment decision concordance, stakeholder acceptability, System Usability Scale scores, and clinician-perceived efficiency.
* **Locations:** Beatson West of Scotland Cancer Centre (NHS GGC); Western General Hospital / Edinburgh Cancer Centre and St John's Hospital, Livingston (NHS Lothian).
* **Funder:** Chief Scientist Office (CSO) PhD Studentship.
...
de Vries CF, Lip G, Staff RT, Dymiter JA, Tse B, Ng A, Fox G, Oberije C, Anderson LA. Prospective evaluation of artificial intelligence integration into breast cancer screening in multiple workflow settings: **The GEMINI Study**. Nat Cancer. 2026 Mar 10. doi: 10.1038/s43018-026-01126-1. Epub ahead of print. PMID: 41807817.
***Key Takeaway*** *The GEMINI study demonstrates that integrating AI into breast cancer screening workflows can maintain or improve cancer detection rates while significantly reducing the workload for human radiologists.*

Williams, L.J., Kunkler, I.H., Taylor, K.J., Dunlop, J., Piper, T., Caldwell, J., Jack, W., Loane, J.F., Elder, K., Bartlett, J.M. and Dixon, J.M., 2024. Postoperative radiotherapy in women with early operable breast cancer (**Scottish Breast Conservation Trial**): 30-year update of a randomised, controlled, phase 3 trial. The Lancet Oncology, 25(9), pp.1213-1221.[Fulltext](https://www.thelancet.com/journals/lanonc/article/PIIS1470-2045(24)00347-4/abstract)
***Key Takeaway:*** *Confirmed that while radiotherapy reduces local recurrence, omitting it in this specific low-risk population did not compromise overall survival even after 30 years.*

Kunkler, I.H., Russell, N.S., Anderson, N., Sainsbury, R., Dixon, J.M., Cameron, D., Loncaster, J., Hatton, M., Westenberg, H., Clarke, J. and McCarty, H., 2025. Ten-year survival after postmastectomy chest-wall irradiation in breast cancer. New England Journal of Medicine, 393(18), pp.1771-1783.[Fulltext](https://www.nejm.org/doi/full/10.1056/NEJMoa2412225)
***Key Takeaway:*** *The **SUPREMO Trial** found no overall survival benefit to adding chest-wall radiation for women with "intermediate-risk" breast cancer (e.g., 1–3 positive nodes) who had undergone mastectomy and standard systemic therapy.*
...
***Key Takeaway:*** *Progesterone Receptor (PR) Allred score is a strong independent predictor of the Oncotype DX Recurrence Score. Patients with a negative PR score were significantly more likely to have a high Recurrence Score (indicating a higher risk of the cancer returning), a relationship that previous key studies had not fully evaluated.*

Stallard, S., Savioli, F., McConnachie, A., Norrie, J., Dudman, K., Morrow, E.S. and Romics, L., 2022. Antibiotic prophylaxis in breast cancer surgery (**PAUS trial**): randomised clinical double-blind parallel-group multicentre superiority trial. British Journal of Surgery, 109(12), pp.1224-1231. [Fulltext](https://academic.oup.com/bjs/article/109/12/1224/6657706)
***Key Takeaway:*** *A single pre-operative dose of antibiotics (co-amoxiclav) did not significantly reduce wound infection rates in routine breast cancer surgery, supporting a reduction in unnecessary antibiotic use.*

Moss, J.G., Wu, O., Bodenham, A.R., Agarwal, R., Menne, T.F., Jones, B.L., Heggie, R., Hill, S., Dixon-Hughes, J., Soulis, E. and Germeni, E., 2021. Central venous access devices for the delivery of systemic anticancer therapy (**CAVA**): a randomised controlled trial. The Lancet, 398(10298), pp.403-415. [Fulltext](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(21)00766-2/abstract)
***Key Takeaway:*** *Established that totally implantable ports (PORTs) are superior to Hickman and PICC lines in terms of safety and quality of life for patients receiving long-term chemotherapy.*